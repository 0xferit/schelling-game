...
const QUESTION_POOL: Question[] = [
  ...
  {
    id: 30,
    text: 'Pick the most beautiful time of year.',
    type: 'select',
    category: 'aesthetics',
    options: [
      'Early spring',
  ...
  {
    id: 38,
    text: "Pick the shade that best represents 'neutral'.",
    type: 'select',
    category: 'aesthetics',
    options: [
      'White',
  ...
  {
    id: 41,
    text: 'Pick the most calming color.',
    type: 'select',
    category: 'aesthetics',
    options: [
      'White',
  ...
  {
    id: 42,
    text: "Pick the color that represents 'moderate'.",
    type: 'select',
    category: 'aesthetics',
    options: [
      'Pure red',
  ...
  {
    id: 43,
    text: 'Pick the color of intelligence.',
    type: 'select',
    category: 'aesthetics',
    options: [
      'Red',
  ...
  {
    id: 45,
    text: 'Pick the color of the future.',
    type: 'select',
    category: 'aesthetics',
    options: [
      'White',
