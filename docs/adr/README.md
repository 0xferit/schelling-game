...
This directory records accepted architecture decisions for the canonical public product.

Format:

- one markdown file per decision
- monotonically increasing numeric prefix
- each ADR records context, decision, and consequences

## Index

| ADR | Title | Status | Date |
| --- | --- | --- | --- |
| [0001](/Users/ferit/Documents/Projects/0xferit/schelling-game/docs/adr/0001-select-only-plurality-public-mode.md) | Select-only plurality public mode | Accepted | 2026-03-23 |
| [0002](/Users/ferit/Documents/Projects/0xferit/schelling-game/docs/adr/0002-persistent-internal-token-economy.md) | Persistent internal token economy | Accepted | 2026-03-23 |
