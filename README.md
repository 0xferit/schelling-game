...
Execution planning for the rewrite lives in [docs/implementation-plan.md](docs/implementation-plan.md).

Ticket-level execution breakdown lives in [docs/ticket-breakdown.md](docs/ticket-breakdown.md).
